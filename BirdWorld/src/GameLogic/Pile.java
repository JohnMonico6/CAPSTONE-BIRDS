...
public class Pile {
	...
	public Pile() {
		...
		Card budgerigar = new Card("Budgerigar", birdAtr, "images/Budgerigar");
		Card bushTurkey = new Card("Bush Turkey", birdAtr, "images/Bush Turkey.PNG");
		Card bushStoneTurkey = new Card("Bush-Stone Curlew", birdAtr, "images/Bush Turkey.PNG");
		...
		Card crestedPidgeon = new Card("Crested Pidgeon", birdAtr, "images/Crested Pidgeon");
		Card crimsonRosella = new Card("Crimson Rosella", birdAtr, "images/Crimson Rosella");
		Card easternWhipbird = new Card("Eastern Whipbird", birdAtr, "images/Eastern Whipbird.png");
		Card galah = new Card ("Galah", birdAtr, "images/Galah");
		Card guidainFinch = new Card("Gouldain Finch", birdAtr, "images/Gouldian Finch");
		Card greyButcherbird = new Card("Grey Bitcherbird", birdAtr, "images/Grey Butcherbird.PNG");
		Card hoodedPlover = new Card("Hooded Plover", birdAtr, "images/Hooded Plover");
		Card kookaburra = new Card("Kookaburra", birdAtr, "images/Kookaburra");
		...
		Card rainbowLorikeet = new Card("Rainbow Lorikeet", birdAtr, "images/Rainbow Lorikeet");
		...
		Card shortTailedShearwater = new Card("Short Tailed Shearwater", birdAtr, "images/Short-Tailed Shearwater");
		Card spurWingedPlover = new Card("Spur-Winged Plover", birdAtr, "images/Spur-Winged Plover.PNG");
		Card suburbFairywren = new Card("Suburn Fairy Wren", birdAtr,"images/Suberd Fairywren.PNG");
		Card sulphurCrestedCockatoo = new Card("Sulphur Crested Cockatoo", birdAtr, "Sulphur Crested Cockatoo.PNG");
		Card superbLurebird = new Card("Superb Lurebird", birdAtr, "Superb Lurebird.PNG");
		Card tawnyFrogmouth = new Card("Tawny Frogmouth", birdAtr, "Tawn Frogmouth.PNG");
		Card torresianCrow = new Card("Torresian Crow", birdAtr, "Torresian Crow.PNG");
		Card welcomeSwallow = new Card("Welcome Swallow", birdAtr, "Welcome Swallow.PNG");
